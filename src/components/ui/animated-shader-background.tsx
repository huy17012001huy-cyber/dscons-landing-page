...
const AnoAI = () => {
  ...
  useEffect(() => {
    ...
    // Optimize performance: render at a lower resolution (CSS will stretch it securely)
    const pixelRatio = window.devicePixelRatio > 1 ? 0.75 : 0.5;
    renderer.setSize(window.innerWidth, window.innerHeight);
    renderer.setPixelRatio(pixelRatio);
    // Force CSS to stretch the canvas to fill the screen
